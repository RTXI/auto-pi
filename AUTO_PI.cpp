...
AUTO_PI::AUTO_PI(void) : DefaultGUIModel("AUTO_PI",::vars,::num_vars)
...
AUTO_PI::~AUTO_PI(void) {}

// execute is run every time step
void AUTO_PI::execute(void)
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
{
...
void AUTO_PI::update(DefaultGUIModel::update_flags_t flag)
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
{
  switch(flag) 
 {
